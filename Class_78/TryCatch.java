...
public class TryCatch {
    public static void main(String args[]){
        ...
        try{
              ...
              System.out.println(nums[1]); // accessing valid index
              System.out.println(nums[5]); // accessing invalid index
        }

        /*catch(Exception e){
            //System.out.println("Something went wrong: " + e);
            System.out.println("Can't divide by zero and array index is invalid");
        } */
