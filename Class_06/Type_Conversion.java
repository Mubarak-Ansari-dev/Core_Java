 ...
 class Type_Conversion{
    public static void main (String args[]){
        ...
        */
        ...
        System.out.println(k); //13 bcoz 13 is within byte range
                      // but if a = 257; then k=1 bcoz byte range is -128 to 127 only
                      // 257 % 256 = 1 remember 256 bcoz byte size is 8 bit = 2^8=256
     
         byte x = 10;
         byte y = 30;
         
         int result = x * y; // byte * byte = int (type promotion)
