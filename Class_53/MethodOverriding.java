...
//create a child class
 class AdvCalc extends Calc{
    ...
    public int add(int n1, int n2){  //overriding the add method of parent class because same method name and same parameters 
        return n1+n2+10;
    }
 }
...
public class MethodOverriding {
    ...
    public static void main(String args[]){
        ...
        int result = obj.add(4,7); // it will call the add method of child class -> if not present then it will call parent class method and result will be 11😎😎
        System.out.println("The result is:" + result); //The result is:21
