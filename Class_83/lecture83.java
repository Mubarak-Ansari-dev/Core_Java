...
public class lecture83 {
    public static void main(String args[]) throws IOException{
       ...
       // int num = System.in.read(); // it throws checked exception so we have to handle it

       InputStreamReader in = new InputStreamReader(System.in);
       BufferedReader bf = new BufferedReader(in);

       // System.out.println(num); // it will print ascii value of the input number
       // System.out.println(num - 48); // it will print actual number by subtracting 48 from ascii value5
       int num = Integer.parseInt(bf.readLine());
       System.out.println(num); // it will print actual number
