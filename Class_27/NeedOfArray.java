...
class Calculator {
    ...
    public int add(int n1, int n2){
         //local variable n1 and n2 created in stack frame of add method
        // System.out.println(num); //instance variable accessed inside the method
        return n1 + n2;
    }
}
...
public class NeedOfArray {
    public static void main (String[] args)
    {
        ...
        Calculator obj2 = new Calculator(); //2nd object created in heap area
        int r1 = obj.add(3, 5);
           //System.out.println(r1);

        obj.num = 9; //modifying instance variable of 1st object

        System.out.println(obj.num); //9
        System.out.println(obj2.num); //6   
    }
}