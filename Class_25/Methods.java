 ...
 */
class Computer{
    public void playMusic(){  // method to play music
        System.out.println("Music Playing..");
    }

    // we can create more methods here
...
public class Methods {
    public static void main(String args[]){
        ...
        Computer obj = new Computer(); // creating an object of Computer class
        obj.playMusic(); // calling playMusic method using object obj   
        String pen = obj.getMeAPen(5); // calling getMeAPen method using object obj
