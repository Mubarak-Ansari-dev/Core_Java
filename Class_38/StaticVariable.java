/*
n this lecture we are discussing:
...
class Mobile  // constructor for Mobile class
{
...
public class StaticVariable {
    public static void main(String args[]){
        ...
        // create first object for Mobile class
        Mobile obj1 = new Mobile();
         obj1.brand = "Vivo";
         obj1.price = 18000;
         obj1.name = "Vivo T2 5G";
         obj1.network = "5G";

        // create second object for Mobile class
        Mobile obj2 = new Mobile();
         obj2.brand = "Samsung";
         obj2.price = 25000;
         obj2.network = "5G";
         obj2.name = "Samsung M32";
