...
1. Working of Java code
2. How is data stored in a database?
3. What are variables?
4. Syntax of variables

#1
-As a Java developer you write a Java code that will be having .java extension and that gets compiledc by javac.
