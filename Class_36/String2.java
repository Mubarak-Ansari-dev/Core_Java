    ...
    public class String2 {
        public static void main(String args[]){
            ...
            String name = "Alam";
            name = name + " Sane"; // here we are not changing existing object "Alam"
            System.out.println("Hello " + name); //Hello Alam Sane
...
// Mutable String -> some changes can be done in existing object
// Immutable String -> no changes can be done in existing object 
// String is immutable