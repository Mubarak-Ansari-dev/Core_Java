...
class MubarakException extends Exception {
  public MubarakException(String str){
    super(str);
  }
}

public class DuckingExcepsn {
  public static void main(String args[]){

    try{
      Class.forName("DuckingExcepsn");
    }
    ...
    try {
      j = 18/i;
      if(j == 0){
        throw new MubarakException("Mubarak Exception Occurred: Division result is zero");
      }
    }
    catch(MubarakException e){
      j = 18/1;
      System.out.println("Default output as j was zero"); 
